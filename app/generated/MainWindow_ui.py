...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.scrollAreaWidgetContents.setGeometry(QtCore.QRect(0, 0, 649, 426))
        ...
        self.line = QtWidgets.QFrame(self.historyFrame)
        self.line.setFrameShape(QtWidgets.QFrame.VLine)
        self.line.setFrameShadow(QtWidgets.QFrame.Sunken)
        self.line.setObjectName("line")
        self.horizontalLayout_2.addWidget(self.line)
        self.txt_scratch_pad = QtWidgets.QPlainTextEdit(self.historyFrame)
        self.txt_scratch_pad.setPlainText("")
        self.txt_scratch_pad.setObjectName("txt_scratch_pad")
        self.horizontalLayout_2.addWidget(self.txt_scratch_pad)
